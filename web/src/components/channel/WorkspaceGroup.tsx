  ...
  return (
    <div className="px-2 pb-1">
      <button
        ...
        className="flex items-center gap-1.5 w-full px-2 py-2 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground hover:text-foreground transition-colors rounded-lg hover:bg-muted/50"
      >
